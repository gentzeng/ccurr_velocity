...
There are two points where fees appeaer - in the difference between inputs and outputs of a transaction - and in the coinbase transaction that gathers fees for the miner. %
