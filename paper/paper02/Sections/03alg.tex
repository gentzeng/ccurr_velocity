...
Transactions using prior transaction fees as inputs are slightly misrepresented in \cite{pernice2019cryptocurrencies}. %

Fees are technically manifest themselves twice - in the difference between inputs and outputs of a transaction - and in the coinbase transaction that gathers fees for the miner. %
