...
\begin{algorithm*}[!h]%
	...
	\ForEach{$d \in \{0,...,\daytt_\maxtt\}$%
		...
		\ForEach{$\TxD$}{%
			$\MSetCirc_{1}[d] \gets \MSetCirc_{1}[d]\,+\,GetMCirc\bigl(t,\,1,\,\Out^{\cbs}\bigr)$\\%
			$\MSetCircLB[d] \gets \MSetCircLB[d]\,+\,GetMCirc\bigl(t,\,\wndw,\,\Out^{\cbs}\bigr)$\\%
			$\MSetCircLA[d] \gets \MSetCircLA[d]\,+\,AdjustMCirc\bigl(t,\,\wndw,\,\Out^{\cbs}\bigr)$\\%
		}
