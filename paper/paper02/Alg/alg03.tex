...
\begin{algorithm*}[!h]%
	\DontPrintSemicolon
	\caption{Aggregation $\protect\MCircM$ for $\mathtt{type}$ (\acs*{fifo}, \acs*{lifo}) within period $\perd$, window $\wndw$.%
...
%
	\KwData{$\MCirc_{\mathtt{cbs}}$ \tcc*{Beginn of look-back window $w$}}%
